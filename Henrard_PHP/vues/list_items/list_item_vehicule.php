<li class='list-group-item'>
    <div class="container-fluid list_item_vehicule">
        <form method='post' action='?page=vehicule&act=edit' class='form-inline col-md-10'>
            ...
            <input type="hidden" name='numero_chassis' value="<?php echo $v['numero_chassis'];?>">
            <input type="hidden" name='plaque' value="<?php echo $v['plaque'];?>">
            <input type="hidden" name='marque' value="<?php echo $v['marque'];?>">
            <input type="hidden" name='modele' value="<?php echo $v['modele'];?>">
